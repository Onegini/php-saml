...
$settings = array(
  ...
  'sp' => array(
    ...
    'assertionConsumerService' => array(
      ...
      'url' => 'http://127.0.0.1:8080/index.php?acs',
    ...
    'singleLogoutService' => array(
      // URL Location where the <Response> from the IdP will be returned
      'url' => 'http://127.0.0.1:8080/index.php?sls',
      // SAML protocol binding to be used when returning the <Response>
  ...
  'idp' => array(
    ...
    'entityId' => 'https://onegini-idp-snapshot.test.onegini.io',
    // SSO endpoint info of the IdP. (Authentication Request protocol)
    'singleSignOnService' => array(
      // URL Target of the IdP where the Authentication Request Message
      // will be sent.
      'url' => 'https://onegini-idp-snapshot.test.onegini.io/saml/single-sign-on',
      // SAML protocol binding to be used when returning the <Response>
      // message. OneLogin Toolkit supports the HTTP-Redirect binding
      // only for this endpoint.
      'binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
    ...
    'singleLogoutService' => array(
      ...
      'url' => 'https://onegini-idp-snapshot.test.onegini.io/saml/single-logout',
      // SAML protocol binding to be used when returning the <Response>
      // message. OneLogin Toolkit supports the HTTP-Redirect binding
      // only for this endpoint.
      'binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
